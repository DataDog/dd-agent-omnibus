...
build do
   ship_license "https://raw.githubusercontent.com/DataDog/datadog-agent/LICENSE"
    ...
    if windows?
      ...
      curl_command = "powershell -Command wget -OutFile #{goout} #{gourl}"
      ...
      curl_command = "curl #{gourl} -o #{goout}"
   ...
   if windows?
    ...
    command "powershell -Command wget -OutFile #{dep} https://github.com/golang/dep/releases/download/v0.5.0/dep-windows-amd64.exe"
