...
gem 'omnibus-software', git: 'git://github.com/datadog/omnibus-software.git', branch: (if ENV['OMNIBUS_SOFTWARE_BRANCH'].to_s.empty? then 'agent-v5' else ENV['OMNIBUS_SOFTWARE_BRANCH'] end)
